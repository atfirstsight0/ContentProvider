...
public class MainActivity extends AppCompatActivity
   ...
   // this method adds records to the content provider.
    public void addRecord(View view){
        ...
        (!((EditText)findViewById(R.id.nickname)).getText().toString().isEmpty())) {
            values.put(CustomContentProvider.NAME, ((EditText)findViewById(R.id.name)).getText().
                    toString());

            values.put(CustomContentProvider.NICK_NAME,
            ...
            Toast.makeText(getBaseContext(), "Please enter the records first",
                    Toast.LENGTH_LONG).show();
        }
    }

    // this method fetches and displays the records.
    public void showAllRecords(View view){
        // Show all the records sorted by friend's name
        String URL = "content://com.ev.provider/nicknames";
        ...
        if(!c.moveToFirst()){
            ...
            do {
                result = result + "\n"
                        ...
                        " has nickname: " + c.getString(
                        c.getColumnIndex(CustomContentProvider.NICK_NAME));
            } while (c.moveToNext());
            if(!result.isEmpty())
    ...
    // this method deletes records rom the content provider.
